namespace ComputationalGeometry.TrapezoidalMap
{
    class TrapezoidalNode : Node
    {
        ...
        public override bool IsTrapezoid()
        {
            return true;
        }
        ...
        public Node To4Traps(Segment segment)
        {
            ...
            Node lowerCenterTrapNode = new TrapezoidalNode(higherCenterTrap);
        ...
        /// <param name="segment"></param>
        /// <returns></returns>
        Node To3TrapsRight_2Left(Segment segment)
        {
            // Vertex node
        ...
        /// <param name="segment"></param>
        /// <returns></returns>
        Node To3TrapsLeft_2Right(Segment segment)
        {
            // Vertex node
            Node root = new VertexNode(segment.LeftVertex);
        ...
        /// <summary>
        /// Return a tree that contains right trapezoid and 2 left trapezoids
        /// (The leftp of higher trapezoid is leftp of old trapezoid and in top)
        /// </summary>
        /// <param name="segment"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Return a tree that contains right trapezoid and 2 left trapezoids
        /// (The leftp of higher trapezoid is leftp of old trapezoid and in bottom)
        /// </summary>
        /// <param name="segment"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Return a tree that contains 2 trapezoids
        /// Top contains rightp and bottom contains leftp
        /// </summary>
        /// <param name="segment"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Return a tree that contains 2 trapezoids
        /// Top contains leftp and bottom contains rightp
        /// </summary>
        /// <param name="segment"></param>
        /// <returns></returns>
